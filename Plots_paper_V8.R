...
#18/02/21
#assessing Lactobacillus relative abundance in the V1V2 dataset
tax_glom(physeq_V1V2, taxrank='Genus')
physeq_V1V2_g_ra<-transform_sample_counts(coherent_taxa_names(tax_glom(physeq_V1V2,"Genus",NArm = F)),
  function(x) x/sum(x))
#Lactobacillus id is ddfeedcb1ed6daac7d0b98921fac6a6b
as.data.frame(otu_table(physeq_V1V2_g_ra))['ddfeedcb1ed6daac7d0b98921fac6a6b',] #->sample 12 has 3.8%